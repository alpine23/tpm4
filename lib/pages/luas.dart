...
class LuasScreen extends StatefulWidget {
  @override
  _LuasScreenState createState() => _LuasScreenState();
}

class _LuasScreenState extends State<LuasScreen> {
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  'Silahkan Input Alas dan Tinggi Segitiga :',
                  style: TextStyle(
                    fontSize: 18,
                    color: Colors.white,
                  ),
